...
class _RasterizeGaussians(torch.autograd.Function):
    ...
    def forward(
        ...
        # print(f"language_feature_precomp shape: {language_feature_precomp.shape}")
        # print(f"opacities shape: {opacities.shape}")
        # print(f"scales shape: {scales.shape}")
        # print(f"rotations shape: {rotations.shape}")
        # print(f"cov3Ds_precomp shape: {cov3Ds_precomp.shape}")
        ...
        # print(f"Output shapes - color: {color.shape}, language_feature: {language_feature.shape}, radii: {radii.shape}")
    ...
    def backward(ctx, grad_out_color, grad_out_language_feature, _):
        ...
        # print(f"Saved tensor shapes during backward:")
        # print(f"colors_precomp: {colors_precomp.shape}")
        # print(f"language_feature_precomp: {language_feature_precomp.shape}")
        # print(f"means3D: {means3D.shape}")
        # print(f"scales: {scales.shape}")
        # print(f"rotations: {rotations.shape}")
        # print(f"cov3Ds_precomp: {cov3Ds_precomp.shape}")
        # print(f"radii: {radii.shape}")
        # print(f"sh: {sh.shape}")
        # print(f"geomBuffer: {geomBuffer.shape}")
        # print(f"binningBuffer: {binningBuffer.shape}")
        # print(f"imgBuffer: {imgBuffer.shape}")
